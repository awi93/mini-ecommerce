...
import (
	...
	repo "github.com/awi93/mini-ecommerce/src/repos/shippingmethod"
	svc "github.com/awi93/mini-ecommerce/src/services/shippingmethod"
	"github.com/spf13/cobra"
	"github.com/spf13/viper"
)

var shippingMethodService svc.Service
...
func Init(config *viper.Viper) error {
	...
	shippingMethodRepo := repo.NewRepo(&repo.Args{
		DB: db,
	})
	shippingMethodService = svc.NewService(&svc.Args{
		Repo: shippingMethodRepo,
	})
...
var Command = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		results, err := shippingMethodService.Import(r)
		if err != nil {
			return err
		}
